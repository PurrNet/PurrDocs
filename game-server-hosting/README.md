...
The cost? Well you need the server hosted somewhere. Whether that is self-hosting or utilizing a platform like [Edgegap](edgegap.md) or [Gameye](gameye.md) to more easily do so.
